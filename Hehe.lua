...
-- 🔊 1. ÂM THANH XIN CHÀO (CHỈ PHÁT 1 LẦN KHI LOAD)
pcall(function()
    local introSound = Instance.new("Sound")
    introSound.SoundId = "rbxassetid://9060817403" -- Âm thanh chào mừng / click
    introSound.Volume = 1
...
pcall(function()
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "DUC ANH HUB v1.0"
        Text = "Đã thêm âm thanh chào mừng lúc loading!",
        Duration = 5
    }
end)
...
-- ==========================================
-- 🟢 2. NÚT TRÒN DI ĐỘNG (TẠO TRƯỚC, ẨN CHỜ LOAD)
-- ==========================================
...
local vipConnection
vipConnection = RunService.RenderStepped:Connect(function()
    if not VipLabel or not VipLabel.Parent then
        if vipConnection then vipConnection:Disconnect() end
        return
    end
    local hue = (os.clock() % 4) / 4
    VipLabel.TextColor3 = Color3.fromHSV(hue, 1, 1)
end)

-- ==========================================
-- 🛠️ 5. CHẠY LOADING XONG HIỆN NÚT TRÒN
-- ==========================================
task.spawn(function()
...
print("🚀 DUC ANH HUB v1.0 Loaded Successfully!")
